...
namespace AppRpgEtec.ViewModels.Personagens
{
    ...
    internal class CadastroPersonagemViewModel : BaseViewModel
    {
        ...
        public string PersonagemSelecionadoId { get => PersonagemSelecionadoId1; set => PersonagemSelecionadoId1 = value; }
        ...
        public async Task SalvarPersonagem()
        {
            try
            {
                ...
                if (model.Id == 0)
                    ...
                    await Application.Current.MainPage.DisplayAlert("Mensagem", "Dados slavos com sucesso!", "Ok");
        ...
        public string PersonagemdelecionadoId
        {
            set
            {
                if (value != null)
